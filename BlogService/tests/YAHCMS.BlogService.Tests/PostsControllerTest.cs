...
namespace YAHCMS.BlogService.Tests
{
    public class PostsControllerTest
    {
        ...
        [Fact]
        public void GetPostFromBlogReturnsNull()
        {
            //repository.GetBlog(1).Posts.Clear();
            var result = controller.GetPost(1, 999);
            Assert.Equal((result.Result as StatusCodeResult).StatusCode, StatusCodes.Status404NotFound);
